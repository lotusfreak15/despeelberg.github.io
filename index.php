...
<html lang="nl">
  <head>
    ...
    <title>Speelplein De Speelberg - Beveren-Leie</title>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="http://foto.despeelberg.be/#!home" target="_blank">Foto's</a></li>
	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-10 col-lg-offset-1 centered">
					...
					<br>
					<a class="iconfacebook" href="https://www.facebook.com/speelpleinwerkingdespeelberg/"><i class="fa fa-facebook fa-lg"></i></a>
				</div><!-- /col-lg-8 -->
			</div><!-- /row -->
	    </div> <!-- /container -->
	</div><!-- /ww -->
		...
		<div class="row">
			<div class="col-lg-10 col-lg-offset-1 centered">
				...
				<div class="col-lg-6 centered">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2517.5724636627297!2d3.3391099!3d50.8761143!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c33c1c0a1d621f%3A0x4eb08a40b7484319!2sTomberg+21%2C+8791+Waregem!5e0!3m2!1snl!2sbe!4v1425072408049" width="450" height="350" frameborder="0" style="border:0"></iframe>
				</div>
				<div class="col-lg-6 centered">
					<h2>Voor wie?</h2>
					...
					<p>Onze speelpleinwerking bestaat uit verschillende dagdelen. Voor een voormiddag betaalt je 1 euro. Tijdens de middag kunnen de boterhammetjes van thuis worden opgegeten, dit kost ook 1 euro, in die prijs zit een drankje tijdens het eten inbegrepen. Een namiddag spelen kost 2 euro, en als vieruurtje wordt weer een drankje voorzien.</p>
				</div>
	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-10 col-lg-offset-1 centered">
                    ...
                    <div class="row">
                        <h2>Paasvakantie</h2>
                        <p>In de paasvakantie zijn we er opnieuw, dit in de tweede week. Onze poort staat open van 10 tot en met 14 april.
                    </div>


                    <div class="row">
                        <h2>Zomervakantie</h2>
                        <p>In de zomervakantie zijn we terug van de partij! We zijn open tijdens de eerste twee weken van juli (3 tot en met 7 juli, 10 tot en met 14 juli) en de laatste 3 weken van augustus (14 tot en met 18 augustus, 21 tot en met 25 augustus, 28 tot en met 31 augustus).
                    </div>
				</div><!-- /col-lg-8 -->
			</div><!-- /row -->
	    </div> <!-- /container -->
    ...
    <div class="container pt" id="facebook">
        <div class="row mt centered">
            ...
            <div class="row">
                ...
                <p>Like dan snel <a href="https://www.facebook.com/speelpleinwerkingdespeelberg/">onze Facebookpagina</a>!
            </div>

            <div class="fb-page" data-href="https://www.facebook.com/speelpleinwerkingdespeelberg" data-tabs="timeline" data-width="500" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/speelpleinwerkingdespeelberg" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/speelpleinwerkingdespeelberg">Speelplein De Speelberg</a></blockquote></div>
        </div><!-- /row -->
    </div>
